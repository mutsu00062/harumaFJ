      ...
      default :
        if(preg_match("/荒|野|行|動|走|野郎/u", $text)){
          $phrase = array(
            ...
            '再起してまた征途に立つ',
            'It is time to love your courage like it is the more precious gold that you’ve been ever given.',
            '満場の桂冠、荒野の光！',
            '荒野の伝説は数多い、だが英雄達は皆の記憶に残る',
            'あきらめる事なく勝利を掴め',
            '栄光も挫折もいずれ過去になる。もう一局！',
            '右上隅の目をスワイプで周りを観察安い',
            '遠征はここで終わりではない、目の前に荒野がある限り',
            '極地両雄',
            '荒野孤狼',
            '英雄とはいくつもの困難を乗り越えた先にあるものだ',
            '早速シートベルトを締めて、準備はいい？',
            '友達を誘うから、ちょっと待って！',
            '友達追加してチームを組もう',
            '行きましょう、もう待てない！',
